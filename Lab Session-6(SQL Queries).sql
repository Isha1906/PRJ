...
select * from tblParents;   /*reading data from table*/
 select EmailId from tblParents;
...
select  count(Parent_id) from tblParents where Annual_Income<500000 or age>45;     /*Counting number of parents whose annual income is less than 5lakh and age greater than 45 */
